...
$GLOBALS['FW_URL_OLD'] = 'http://masrenovable.com/dev/wp_gc';
$GLOBALS['FW_URL_NEW'] = 'http://masrenovable/dev/wp_gc';
$GLOBALS['FW_PACKAGE_NAME'] = 'v0_2b_20140428_distribuidoragcenlinea_535fac1b864612954140429134147_archive.zip';
$GLOBALS['FW_PACKAGE_NOTES'] = 'Respaldo de aplicacion con:
-Catalogo completo
-Precio por cliente funcional
*PAQUETE PARA RESTAURACION EN EL MISMO HOST.
**No incluye el directorio uploads ni SQL dump';
$GLOBALS['FW_SECURE_NAME'] = 'v0_2b_20140428_distribuidoragcenlinea_535fac1b864612954140429134147';
$GLOBALS['FW_DBHOST'] = 'localhost';
$GLOBALS['FW_DBHOST'] = empty($GLOBALS['FW_DBHOST']) ? 'localhost' : $GLOBALS['FW_DBHOST'];
$GLOBALS['FW_DBNAME'] = 'masrenov_wpDevGC';
$GLOBALS['FW_DBUSER'] = 'masrenov_admin';
$GLOBALS['FW_DBPASS'] = '';
$GLOBALS['FW_SSL_ADMIN'] = 0;
$GLOBALS['FW_SSL_LOGIN'] = 0;
$GLOBALS['FW_CACHE_WP'] = 0;
$GLOBALS['FW_CACHE_PATH'] = 0;
$GLOBALS['FW_BLOGNAME'] = 'Distribuidora GC En Línea';
$GLOBALS['FW_WPROOT'] = '/home/masrenov/public_html/dev/wp_gc/';
