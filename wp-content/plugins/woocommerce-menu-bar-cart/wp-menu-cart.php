	...
	*/
	...
	public function wpmenucart_menu_item() {
		...
		if ($item_data['cart_contents_count'] == 0) {
			/* Hack para ver el carrito de compras al dar clic */
			$menu_item_href = apply_filters ('wpmenucart_emptyurl', 'http://masrenovable.com/dev/wp_gc/?page_id=9' );
			//$menu_item_href = apply_filters ('wpmenucart_emptyurl', $item_data['woocommerce_cart'] );
